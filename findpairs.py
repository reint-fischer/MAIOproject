...
Data_Mediterrean = np.genfromtxt('Data/MedSeaIDs.txt', delimiter=',')  # Open reanalysed data
...
np.savetxt('Data/Pair.txt',Pair,delimiter=',')      #Save the IDs (iterations)
np.savetxt('Data/UnPair.txt',UnPair,delimiter=',')  #Save the IDs (couples)
